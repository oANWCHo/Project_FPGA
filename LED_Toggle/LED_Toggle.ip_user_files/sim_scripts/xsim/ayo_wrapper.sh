...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L processing_system7_vip_v1_0_19 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot ayo_wrapper xil_defaultlib.ayo_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ayo_wrapper -key {Behavioral:sim_1:Functional:ayo_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/ayo.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ayo_wrapper.wdb xsim.dir libdpi.so)
