...
#
# Script generated by Vivado on Thu Oct 31 17:22:57 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ayo_wrapper.sh
...
#
# Usage        : ayo_wrapper.sh
#                ayo_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ayo_wrapper.sh [-reset_run]
#                ayo_wrapper.sh [-reset_log]
#                ayo_wrapper.sh [-help]
#
...
#                script (type 'ayo_wrapper.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ayo_wrapper.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ayo_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Toggle.srcs/sources_1/new/led_blinkx2.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ayo_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ayo_wrapper -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ayo_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ayo_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ayo_wrapper.sh [-help]\n\
Usage: ayo_wrapper.sh [-step]\n\
Usage: ayo_wrapper.sh [-lib_map_path]\n\
Usage: ayo_wrapper.sh [-reset_run]\n\
Usage: ayo_wrapper.sh [-reset_log]\n\
Usage: ayo_wrapper.sh [-keep_index]\n\
Usage: ayo_wrapper.sh [-noclean_files]\n\n\
