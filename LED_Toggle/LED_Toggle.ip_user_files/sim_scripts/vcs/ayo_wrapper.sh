...
design_libs=(xilinx_vip xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../../../../../year/ 3/1/MBED/FPGA/LED_Toggle/LED_Toggle.srcs/sources_1/new/led_blinkx2.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/ec67/hdl" +incdir+"../../../LED_Toggle.gen/sources_1/bd/ayo/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  "../../../../../../../../year/ 3/1/MBED/FPGA/LED_Toggle/LED_Toggle.gen/sources_1/bd/ayo/hdl/ayo_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ayo_wrapper xil_defaultlib.glbl -o ayo_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ayo_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ayo_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ayo_wrapper_simv.daidir vcs_lib c.obj)
