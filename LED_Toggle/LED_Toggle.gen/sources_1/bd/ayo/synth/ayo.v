...
//Date        : Thu Oct 31 17:23:18 2024
//Host        : NaNO2 running 64-bit major release  (build 9200)
//Command     : generate_target ayo.bd
//Design      : ayo
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ayo,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ayo,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "ayo.hwdef" *) 
module ayo
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire led_blinkx2_0_led1;
  wire led_blinkx2_0_led2;
  ...
  assign led2_0 = led_blinkx2_0_led2;
  assign led_0 = led_blinkx2_0_led1;
  ayo_led_blinkx2_0_0 led_blinkx2_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .led1(led_blinkx2_0_led1),
        .led2(led_blinkx2_0_led2));
  ayo_processing_system7_0_0 processing_system7_0
