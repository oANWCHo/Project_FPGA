...
//Date        : Wed Oct 30 15:59:23 2024
//Host        : NaNO2 running 64-bit major release  (build 9200)
//Command     : generate_target miniZED.bd
//Design      : miniZED
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "miniZED,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=miniZED,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "miniZED.hwdef" *) 
module miniZED
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  miniZED_processing_system7_0_0 processing_system7_0
