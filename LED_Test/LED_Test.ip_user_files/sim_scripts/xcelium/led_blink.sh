...
#
# Script generated by Vivado on Wed Oct 30 14:00:56 +0700 2024
...
#
# Usage        : led_blink.sh
#                led_blink.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                led_blink.sh [-reset_run]
#                led_blink.sh [-reset_log]
#                led_blink.sh [-help]
#
...
#                script (type 'led_blink.sh -help' for more information).
#
...
# script info
echo -e "led_blink.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./led_blink.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/ec67/hdl" +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/ec67/hdl" +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../LED_Test.srcs/sources_1/new/tog.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.led_blink xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.led_blink -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log led_blink_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: led_blink.sh [-step]\n\
Usage: led_blink.sh [-lib_map_path]\n\
Usage: led_blink.sh [-reset_run]\n\
Usage: led_blink.sh [-reset_log]\n\
Usage: led_blink.sh [-keep_index]\n\
