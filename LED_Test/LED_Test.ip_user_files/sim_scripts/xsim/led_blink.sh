...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot led_blink xil_defaultlib.led_blink xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim led_blink -key {Behavioral:sim_1:Functional:led_blink} -tclbatch cmd.tcl -protoinst "protoinst_files/miniZED.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb led_blink.wdb xsim.dir libdpi.so)
