...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/ec67/hdl" +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/ec67/hdl" +incdir+"../../../LED_Test.gen/sources_1/bd/miniZED/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../../../../../year/ 3/1/MBED/FPGA/LED_Test/LED_Test.srcs/sources_1/new/tog.v" \
...
reset_run()
{
  files_to_remove=(ucli.key led_blink_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc led_blink_simv.daidir vcs_lib c.obj)
