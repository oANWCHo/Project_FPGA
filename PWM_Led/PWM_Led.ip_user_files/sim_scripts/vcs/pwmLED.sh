...
#
# Script generated by Vivado on Wed Oct 30 09:44:59 +0700 2024
...
#
# Usage        : pwmLED.sh
#                pwmLED.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwmLED.sh [-reset_run]
#                pwmLED.sh [-reset_log]
#                pwmLED.sh [-help]
#
...
#                script (type 'pwmLED.sh -help' for more information).
#
...
# script info
echo -e "pwmLED.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwmLED.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../../../../../year/ 3/1/MBED/FPGA/PWM_Led/PWM_Led.srcs/sources_1/new/pwmLED.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwmLED xil_defaultlib.glbl -o pwmLED_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwmLED_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pwmLED_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pwmLED_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwmLED.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwmLED.sh [-help]\n\
Usage: pwmLED.sh [-step]\n\
Usage: pwmLED.sh [-lib_map_path]\n\
Usage: pwmLED.sh [-reset_run]\n\
Usage: pwmLED.sh [-reset_log]\n\
Usage: pwmLED.sh [-keep_index]\n\
Usage: pwmLED.sh [-noclean_files]\n\n\
