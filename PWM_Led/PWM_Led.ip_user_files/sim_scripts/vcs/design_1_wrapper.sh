...
compile()
{
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../PWM_Led.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"D:/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  "../../../../../../../../year/ 3/1/MBED/FPGA/PWM_Led/PWM_Led.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
