...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot pwmLED xil_defaultlib.pwmLED xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pwmLED -key {Behavioral:sim_1:Functional:pwmLED} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pwmLED.wdb xsim.dir libdpi.so)
