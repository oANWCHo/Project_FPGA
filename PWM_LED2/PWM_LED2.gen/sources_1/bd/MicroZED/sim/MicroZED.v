...
//Date        : Thu Oct 31 07:40:52 2024
//Host        : NaNO2 running 64-bit major release  (build 9200)
//Command     : generate_target MicroZED.bd
//Design      : MicroZED
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "MicroZED,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MicroZED,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "MicroZED.hwdef" *) 
module MicroZED
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire pwmLED_0_PL_LED_G;

  assign PL_LED_G_0 = pwmLED_0_PL_LED_G;
  MicroZED_processing_system7_0_0 processing_system7_0
  ...
  MicroZED_pwmLED_0_0 pwmLED_0
       (.PL_LED_G(pwmLED_0_PL_LED_G),
